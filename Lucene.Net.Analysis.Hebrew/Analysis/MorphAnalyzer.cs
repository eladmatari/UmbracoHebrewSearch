...
namespace Lucene.Net.Analysis.Hebrew
{
    public class MorphAnalyzer : Analyzer
    {
            ...
            : base()
        {
            ...
            string dictionaryFolder = ConfigurationManager.AppSettings["HebMorph.Hspell.Path"] ?? Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "hspell-data-files");
            hebMorphLemmatizer.InitFromHSpellFolder(dictionaryFolder, true, false);
